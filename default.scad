...
armature(animations=anim_data) {
    ...
    color([0.15, 0.08, 0.03, 1.0], roughness=0.8, clearcoat=1.0, clearcoatRoughness=0.02, ior=1.5, autoSmoothAngle=30) {
        cylinder(h=2, r=24);
    ...
    translate([0, 0, 5])
    color([0.0, 0.0, 0.0, 1.0], emissive=[0.0, 0.6, 1.0], emissiveIntensity=4.0, autoSmoothAngle=45) {
    ...
    translate([0, 0, 5.5])
    color([0.7, 0.05, 0.1, 1.0], roughness=0.9, sheen=1.0, sheenColor=[1.0, 0.3, 0.3], sheenRoughness=0.6, specularColor=[0.5, 0.1, 0.1], specularIntensity=0.5, autoSmoothAngle=60)
        scale([1, 1, 0.3]) sphere(r=18);

    // Bronze support pillars
    color([0.8, 0.5, 0.2, 1.0], metalness=1.0, roughness=0.4, autoSmoothAngle=35) {
        // Vertical stands
    ...
    bone(name="OuterRing", t=[0,0,26]) {
        ...
        color([1.0, 0.84, 0.0, 1.0], metalness=1.0, roughness=0.1, autoSmoothAngle=45) {
        ...
        bone(name="InnerRing", t=[0,0,0]) {
            ...
            color([0.6, 0.6, 0.65, 1.0], metalness=0.9, roughness=0.05, iridescence=1.0, iridescenceIOR=1.6, autoSmoothAngle=45) {
            ...
            bone(name="Gem", t=[0,0,0]) {
                ...
                // Showcasing: autoSmoothAngle=0.0 (Preserves faceted "cut" look of the crystal)
