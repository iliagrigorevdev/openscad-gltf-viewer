...
import { HDRLoader } from "three/examples/jsm/loaders/HDRLoader.js"; // <-- Changed to HDRLoader
...
copyPromptBtn.onclick = async () => {
  ...
  const promptText = `Generate an OpenSCAD script to design the following: ${desc}.
